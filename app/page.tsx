...
const PIN_OPTIONS = [
	...
	},
	{
		...
		label: (
			<>
				นี่ทางมาลายเฮ้ยย!! <br /> เบรคหน่อยก็ได้
			</>
		),
	...
	},
	{
		...
		label: (
			<>
				ตัดแว่นหน่อยมั้ย <br /> ลูกศรมันชี้ไปอีกทาง
			</>
		),
	...
	},
	{
		...
		label: <>ตาบอดสี ไฟจราจรมีแต่สีเขียว</>,
	...
	return (
		<motion.button
			...
			className={`w-1/2 h-full flex items-center justify-center gap-1 font-semibold ${
				active ? "bg-blue-400 text-white" : "bg-gray-100 text-gray-500 hover:bg-gray-200"
			}`}
		>
